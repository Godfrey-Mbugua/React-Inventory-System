...
// Custom Css
import './index.css';
// Function to format numbers as KSH
const valueFormatter = (number) => (
    `KSH ${Intl.NumberFormat('en-KE').format(number).toString()}`
);


// Updated transactions array with formatted amounts
export const transactions = [
    {
        ...
        amount: valueFormatter(4805), // Convert from string to number and format
    ...
    },
    {
        ...
        amount: valueFormatter(2344), // Convert from string to number and format
