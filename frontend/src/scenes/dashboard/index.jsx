...
import { expenses, transactions } from "../purchases/expenses";
...
const kpiData = [
    {
        title: 'Sales',
        metric: dataFormatter(120699), // Use the dataFormatter function
        progress: 15.9,
        target: dataFormatter(80000), // Use the dataFormatter function
        delta: '13.2%',
        deltaType: 'moderateIncrease',
    },
    {
        title: 'Profit',
        metric: dataFormatter(45564), // Use the dataFormatter function
        progress: 36.5,
        target: dataFormatter(125000), // Use the dataFormatter function
        delta: '23.9%',
        deltaType: 'increase',
    },
    {
        title: 'Customers',
        metric: '1,072', // This remains as it is since it's not a currency value
        progress: 53.6,
        target: '2,000',
        delta: '10.1%',
                        ...
                        <ColGrid numColsMd={ 2 } numColsLg={ 2 } marginTop="mt-6" gapX="gap-x-6" gapY="gap-y-6">
                            ...
                            <Card maxWidth="max-w-lg" decoration="left" decorationColor="blue">
                                <Flex>
                                    <Block>
                                        <Text>Payables</Text>
                                        <Metric>{dataFormatter(calc_payables())}</Metric> {/* changed */}
                                    </Block>
            ...
            <Flex alignItems="items-center">
                ...
                <Block truncate={ true }>
                    ...
                    <Metric truncate={ true }>
                        {
                            item.type === 'currency' ?
                            dataFormatter(item.metric) : item.metric 
                        }
                    </Metric>
                </Block>
